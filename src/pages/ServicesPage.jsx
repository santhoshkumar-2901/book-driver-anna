...
import { 
  ...
  Sparkles, Fuel, Users, ArrowRight, DollarSign, Filter, Moon, Compass, Briefcase, Navigation, Calendar, User, Phone, Check, Bus
} from 'lucide-react';
import { SteeringWheel } from '../components/Icons';
import { BOOK_DRIVER_TRIP_TYPES, VEHICLE_SERVICES, BANGALORE_AREAS } from '../data/mockData';

export default function ServicesPage({ openBookingModal }) {
  const [activeServiceTab, setActiveServiceTab] = useState('driver'); // 'driver' or 'vehicle'
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
      ...
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        ...
        <p className="text-slate-300 text-base leading-relaxed">
          Choose from <span className="text-amber-400 font-semibold">Book a Driver</span> (One Way, Round Trip, Outstation) or <span className="text-amber-400 font-semibold">Book a Vehicle</span> (Sedan, SUV, 12 Seater, 24 Seater, 32 Seater).
        </p>

        {/* Primary Service Selector */}
        <div className="inline-flex p-1.5 bg-slate-900 rounded-2xl border border-slate-800 shrink-0 mt-4">
          <button
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 pt-2 bg-slate-950/70 p-4 rounded-2xl border border-slate-800">
                  ...
                  <div className="grid grid-cols-2 gap-1.5 pt-1">
                    {['Round trip 12hr', 'Round trip 24hr', 'Round trip 46hr', 'Round trip 72hr'].map((pkg) => (
                  ...
                  <div className="flex items-center gap-2 text-xs text-slate-300 pt-1">
                    <Check className="w-4 h-4 text-emerald-400 shrink-0" />
                    <span>Pickup & Destination Spot</span>
                  </div>
                </div>
              </div>
