      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl sm:rounded-3xl p-4 sm:p-6 space-y-4 sm:space-y-6 min-w-0">
        ...
        {driverBookings.length === 0 ? (
          <div className="bg-slate-950 p-8 rounded-2xl border border-slate-800 text-center space-y-2">
            <SteeringWheel className="w-8 h-8 text-amber-400/50 mx-auto" />
            <div className="text-sm font-bold text-white">No Active Driver Dispatches</div>
            <div className="text-xs text-slate-500">Live Bangalore customer driver bookings will automatically stream into this dispatch queue.</div>
          </div>
        ) : (
